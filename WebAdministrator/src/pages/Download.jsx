...
const Download = () => {
    return(
        <div>
            ...
            <h5 className={classes.text_alt}>Si estas viendo esto desde un dispositivo móvil, descargala <a href="http://3.144.21.179:8000/bazar/download-apk-hnp/">aqui</a></h5>
        </div>
    );
};
