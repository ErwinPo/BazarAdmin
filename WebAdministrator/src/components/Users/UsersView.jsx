...
const UsersView = () => {
  ...
  useEffect(() => {
    fetch("http://192.168.1.68:8000/bazar/users//", {
      method: "GET",
      headers: {
  ...
  const handleEditUser = () => {
    ...
    fetch(`http://192.168.1.68:8000/bazar/users//${id}/`, {
      method: "PUT",
      headers: {
        'Authorization': `Bearer ${token}`,
        "Content-Type": "application/json"
  ...
  const handleChangePassword = () => {
    ...
    fetch(`http://192.168.1.68:8000/bazar/change-password/`, {
      method: "POST",
      headers: {
        'Authorization': `Bearer ${token}`,
        "Content-Type": "application/json"
  ...
  const handleDeleteUsers = () => {
    ...
    fetch("http://192.168.1.68:8000/bazar/delete-users/", {
      method: "DELETE",
      headers: {
        'Authorization': `Bearer ${token}`,
        "Content-Type": "application/json",
